...
fn test_previous_damage_dealt_resets_and_then_goes_to_a_new_value() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::COUNTER);
    state
        .side_two
        .get_active()
...
fn test_counter_reflects_special_hiddenpower() {
    ...
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::HIDDENPOWERWATER70);
...
fn test_mirrorcoat_does_not_reflect_special_hiddenpower() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::MIRRORCOAT);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::HIDDENPOWERWATER70);
...
fn test_metalburst_after_physical_move() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::METALBURST);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
...
fn test_comeuppance_after_physical_move() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::COMEUPPANCE);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
...
fn test_metalburst_after_special_move() {
    ...
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::WATERGUN);
...
fn test_focuspunch_after_getting_hit() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::FOCUSPUNCH);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
