...
fn test_last_used_move_overwritten_when_dragged_out() {
    ...
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::WHIRLWIND);
...
fn test_encore_slow() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::ENCORE);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M1, Choices::WATERGUN);
...
fn test_encore_slow_into_substitute() {
    ...
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::SUBSTITUTE);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M1, Choices::WATERGUN);
...
fn test_fast_encore_into_using_a_different_move_from_lum() {
    ...
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M1, Choices::SWORDSDANCE);
...
fn test_encore_expires_at_2_turns() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::NONE);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
...
fn test_fakeout_first_turn_switched_in() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::FAKEOUT);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
...
fn test_firstimpression_first_turn_switched_in() {
    ...
    state
        .side_one
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::FIRSTIMPRESSION);
    state
        .side_two
        .get_active()
        .replace_move::<GEN>(PokemonMoveIndex::M0, Choices::TACKLE);
